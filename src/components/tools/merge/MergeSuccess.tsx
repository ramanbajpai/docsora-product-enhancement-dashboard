...
export function MergeSuccess({ file, onReset }: MergeSuccessProps) {
  const navigate = useNavigate();

  const handleDownload = () => {
    // In real implementation, would download the merged PDF
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground whitespace-nowrap">
                    Unlock Pro — batch merge & advanced ordering
                  </h3>
                  <p className="text-xs text-muted-foreground/70 mt-0.5 whitespace-nowrap">
                    Merge multiple sets • Custom page order • No limits
                  </p>
                </div>
              </div>
