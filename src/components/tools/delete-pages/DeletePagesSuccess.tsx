...
interface DeletePagesSuccessProps {
  file: File;
  onReset: () => void;
}
...
export const DeletePagesSuccess = ({ file, onReset }: DeletePagesSuccessProps) => {
  return (
    <div className="w-full max-w-2xl mx-auto py-10 px-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground whitespace-nowrap">
                    Unlock Pro — batch processing & undo history
                  </h3>
                  <p className="text-xs text-muted-foreground/70 mt-0.5 whitespace-nowrap">
                    Multi-file editing • Restore deleted pages • No file limits
                  </p>
                </div>
              </div>
      ...
      <motion.p
        ...
        className="text-[10px] text-center text-muted-foreground/30"
      >
        Files are processed securely and removed automatically after editing.
      </motion.p>
    </div>
  );
};

export default DeletePagesSuccess;
