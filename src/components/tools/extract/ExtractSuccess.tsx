...
export function ExtractSuccess({ files, extractedCount, onReset }: ExtractSuccessProps) {
  const fileName = files[0]?.name || "document.pdf";
  const outputName = fileName.replace(".pdf", "_extracted.pdf");
    ...
    <div className="w-full max-w-2xl mx-auto py-10 px-4">
      ...
      >
        ...
        >
          <span className="text-primary font-semibold">
            <AnimatedCounter value={extractedCount} suffix={extractedCount === 1 ? " page extracted" : " pages extracted"} delay={1200} />
          </span>
        </motion.p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <span className="relative z-10">Download Extracted Pages</span>
        </motion.button>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground whitespace-nowrap">
                    Unlock Pro — extract with smart selection
                  </h3>
                  <p className="text-xs text-muted-foreground/70 mt-0.5 whitespace-nowrap">
                    Batch extract • Custom page ranges • Auto-detect sections
                  </p>
                </div>
              </div>
      ...
      >
        <p className="text-[9px] text-muted-foreground/30 text-center">
          Files are processed securely and removed automatically after extraction.
        </p>
      </motion.div>
    </div>
  );
