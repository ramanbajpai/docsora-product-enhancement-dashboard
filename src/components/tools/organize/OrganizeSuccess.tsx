...
export function OrganizeSuccess({ files, pagesReordered = 3, onReset }: OrganizeSuccessProps) {
  const fileName = files[0]?.name || "document.pdf";
  const outputName = fileName.replace(".pdf", "_organized.pdf");
    ...
    <div className="w-full max-w-2xl mx-auto py-10 px-4">
      ...
      >
        ...
        >
          <span className="text-primary font-semibold">
            <AnimatedCounter value={pagesReordered} suffix={pagesReordered === 1 ? " page reordered" : " pages reordered"} delay={1200} />
          </span>
        </motion.p>
      </motion.div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground whitespace-nowrap">
                    Unlock Pro — organize with templates
                  </h3>
                  <p className="text-xs text-muted-foreground/70 mt-0.5 whitespace-nowrap">
                    Batch organize • Saved layouts • Auto-arrange
                  </p>
                </div>
              </div>
      ...
      >
        <p className="text-[9px] text-muted-foreground/30 text-center">
          Files are processed securely and removed automatically after organizing.
        </p>
      </motion.div>
    </div>
  );
