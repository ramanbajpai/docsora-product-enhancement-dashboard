...
interface MetadataUpdateSuccessProps {
  files: File[];
  onReset: () => void;
}
...
export function MetadataUpdateSuccess({ files, onReset }: MetadataUpdateSuccessProps) {
  return (
    <div className="w-full max-w-2xl mx-auto py-10 px-4">
      ...
      >
        ...
        >
          Document properties have been saved
        </motion.p>
      </motion.div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground whitespace-nowrap">
                    Unlock Pro — batch edit metadata across files
                  </h3>
                  <p className="text-xs text-muted-foreground/70 mt-0.5 whitespace-nowrap">
                    Custom templates • Bulk processing • Preset profiles
                  </p>
                </div>
              </div>
