...
interface MetadataRemoveSuccessProps {
  files: File[];
  onReset: () => void;
}
...
export function MetadataRemoveSuccess({ files, onReset }: MetadataRemoveSuccessProps) {
  return (
    <div className="w-full max-w-2xl mx-auto py-10 px-4">
      ...
      >
        ...
        >
          Your document is now privacy-safe
        </motion.p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <span className="relative z-10">Download Clean Document</span>
        </motion.button>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground whitespace-nowrap">
                    Unlock Pro — batch clean metadata from files
                  </h3>
                  <p className="text-xs text-muted-foreground/70 mt-0.5 whitespace-nowrap">
                    Bulk processing • Folder scanning • Automated cleanup
                  </p>
                </div>
              </div>
