...
export function ProtectSuccess({ file, onReset }: ProtectSuccessProps) {
  const fileName = file?.name?.replace(/\.[^/.]+$/, '') + '_protected.pdf' || 'protected_document.pdf';
    ...
    <div className="w-full max-w-2xl mx-auto py-10 px-4 min-h-[calc(100vh-8rem)] flex flex-col justify-center">
      ...
      >
        ...
        >
          ...
          <span className="relative z-10">Download Protected Document</span>
        </motion.button>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground whitespace-nowrap">
                    Unlock Pro — advanced security options
                  </h3>
                  <p className="text-xs text-muted-foreground/70 mt-0.5 whitespace-nowrap">
                    Batch protection • Custom permissions • Certificate encryption
                  </p>
                </div>
              </div>
      ...
      >
        Files are processed securely and removed automatically after protection.
      </motion.p>
    </div>
  );
}