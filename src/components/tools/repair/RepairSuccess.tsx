...
export function RepairSuccess({ files, onReset }: RepairSuccessProps) {
  return (
    <div className="w-full max-w-2xl mx-auto py-10 px-4">
      ...
      >
        ...
        >
          Your PDF has been fixed and is ready to use
        </motion.p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <span className="relative z-10">Download Repaired Document</span>
        </motion.button>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground whitespace-nowrap">
                    Unlock Pro — repair files in bulk
                  </h3>
                  <p className="text-xs text-muted-foreground/70 mt-0.5 whitespace-nowrap">
                    Batch processing • Advanced recovery • Priority support
                  </p>
                </div>
              </div>
