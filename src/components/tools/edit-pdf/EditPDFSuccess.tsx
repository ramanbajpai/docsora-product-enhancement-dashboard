...
export function EditPDFSuccess({ file, onReset }: EditPDFSuccessProps) {
  return (
    <div className="w-full max-w-2xl mx-auto py-10 px-4">
      ...
      >
        ...
        >
          All your changes have been applied successfully
        </motion.p>
      </motion.div>
      ...
      >
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative px-5 py-4 backdrop-blur-xl">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-sm font-semibold text-foreground">
                  Unlock Pro — advanced editing with OCR & batch processing
                </h3>
                <p className="text-xs text-muted-foreground/70 mt-0.5">
                  Text recognition • Form filling • Unlimited edits
                </p>
              </div>
